...
function applySessionToNav(){
  ...
  // "My Kundlis" only makes sense once signed in — toggle regardless of
  // whether this particular page also has a Sign In button in its nav.
  document.querySelectorAll('.nav-my-kundlis').forEach(el => {
